...
Version  : 0.3.2
Release  : 18
URL      : https://cran.r-project.org/src/contrib/rappdirs_0.3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rappdirs_0.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611766050
